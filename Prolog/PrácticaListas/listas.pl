...
% Javier Guillén Domínguez - 218828421
% Milton Mejía Medina - 218655373
% José Luis Navarrete Jiménez - 213575622
% José Luis Zavala Arevalo - 218574489
...
opcion_1:-
    writeln('Escriba el nombre de la lista, termine con un punto y de un enter, después ponga'),
    writeln('el nombre del elemento a buscar y termine con un punto y dé un ultimo enter'),
...
opcion_2:-
    writeln('Para listar escriba el nombre de la lista y verá todos los elementos de esta'),
...
opcion_4:-
    writeln('Escriba el nombre del elemento que desea agregar, despues ponga punto y dé ENTER,'),
...
opcion_5:-
    ...
    writeln('Escriba el nombre de la lista en la que buscará y de ENTER'),
    writeln('EJEMPLO: elemento.(ENTER)   lista.(ENTER)'),
    read(E), read(L),
    elementoList(L,E),
    guardar,
...
elementoList(L, E) :-
    ...
    retract(listas(L, _)),
    asserta(listas(L, Nl)),
    writeln('Lista actualizada con éxito!').
