...
Menu :-
    ...
    repeat,
    write('Bienvenid@, Seleccione una opción:'), nl,
    write('1. Mostrar Todo'), nl,
    write('2. Agregar'), nl,
    write('3. Buscar por Elemento'), nl,
    write('4. Buscar por Número Atómico'), nl,
...
opcion_2 :-
    ...
    write('el nombre del elemento en minúsculas, luego de un ENTER.'), nl,
    write('despues agrege su número atómico y de ENTER por última vez.'), nl,
...
opcion_3 :-
    ...
    write('encontrar en minúsculas y termine con un punto'), nl,
    write('EJEMPLO: helio.'), nl,
    read(E), buscaE(E).

opcion_4 :-
    write('Escriba el Número Atómico del elemento que'), nl,
...
opcion_5 :-
    ...
    write('nombre del elemento en minúsculas y termine'), nl,
...
opcion_6 :-
    ...
    write('minúsculas, finalice con un punto y luego de un ENTER. Después'), nl,
    writeln("escriba el número atómico del elemento que desea editar y dé un ENTER."),
    write('EJEMPLO: helio.(ENTER) 1.(ENTER)'), nl,
    read(E),read(N),
    editar(E,N).
...
agregar(E,N):- asserta(elementos(E,N)),
    guardar,
    write('Nuevo Elemento Agregado con Éxito!!'), nl,nl.

buscaE(E):-elementos(E,Nd),
    write("Elemento = "), write(E),nl, write("No. Atómico = "),
    write(Nd),nl,nl,
    menu().
...
buscarN(N):-elementos(Ed,N),
    write("No. Atómico = "), write(N), nl, write("Elemento = "),
    write(Ed),nl,
    menu().
...
eliminar(E):-elementos(E,N),
    ...
    guardar,
    write('Elemento eliminado con éxito...'), nl,nl.
...
editando:-
    ...
    write('y de un ENTER. Después escriba el número atómico,'), nl,
    write('termine con un punto y de un ultimo ENTER'), nl,
    write('EJEMPLO: helio.(ENTER) 1.(ENTER)'), nl,
    read(E),read(N),
    asserta(elementos(E,N)),
    guardar,
    writeln("El Elemento se Editó con Éxito!!"),nl.
