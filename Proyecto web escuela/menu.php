...
.centro {
    ...
    .filtro {
            display: none; /* Oculta los elementos que no coinciden con la búsqueda */
        }
...
<body>
    ...
    <div class="rectangulo">
        <div class="row">
            <div class="col">
                <input type="text" class="form-control" id="buscador" placeholder="Buscar por nombre" aria-label="First name">
            </div>
        </div>
    </div>
    ...
    <div class="centro">
        <div class="centrado">
            ...
            <table class="table" id="result-table">
                ...
                $sql = "SELECT * FROM usuarios WHERE estado='activo' ORDER BY idUsuario DESC LIMIT $inicio, $elementos";
                ...
                ?>
                    ...
                    <tbody class="table-group-divider">
                        <?php while ($datos = $resultado->fetch_object()): ?>
                            <tr>
                                <td class="nombreT"><?= htmlspecialchars($datos->Nombre) ?></td>
        ...
        <div class="centro2">
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <?php if ($page > 1): ?>
                        <li class="page-item">
                            <a class="page-link" href="menu.php?page=<?= $page - 1 ?>">Anterior</a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if ($page < $total_pages): ?>
                        <li class="page-item">
                            <a class="page-link" href="menu.php?page=<?= $page + 1 ?>">Siguiente</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </nav>
